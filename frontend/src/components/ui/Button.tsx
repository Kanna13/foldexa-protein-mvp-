...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = "primary", size = "md", isLoading, children, ...props }, ref) => {
        ...
        const variants = {
            primary: "bg-primary text-black font-bold shadow-[0_0_15px_rgba(0,217,126,0.2)] hover:bg-[#00c472] hover:shadow-[0_0_25px_rgba(0,217,126,0.3)] border-0",
            ...
            outline: "bg-transparent border border-[#d2d2d7] text-[#1d1d1f] hover:bg-[#f5f5f7] hover:border-[#86868b]",
        };
