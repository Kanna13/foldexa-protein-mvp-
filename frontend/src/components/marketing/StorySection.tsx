...
export function StorySection() {
    ...
    return (
        <section className="bg-[#0A0A0A] text-white py-32 relative overflow-hidden font-sans">
            {/* Background Ambience */}
                                        ...
                                        >
                                            ...
                                            <div className="grid md:grid-cols-5 h-full max-h-[85vh] overflow-y-auto">
                                                ...
                                                <div className="md:col-span-3 p-10 md:p-12 bg-[#111]">
                                                    <h4 className="text-sm font-bold text-emerald-500 uppercase tracking-widest mb-8">The Story</h4>
