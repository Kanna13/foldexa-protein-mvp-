...
//             >
//               <Link href="/app/new">
//                 <Button variant="primary" size="lg" className="min-w-[200px] shadow-[0_0_40px_rgba(0,255,148,0.3)] hover:shadow-[0_0_60px_rgba(0,255,148,0.5)] transition-shadow duration-500 h-14 px-8 text-lg">
    ...
    <div className="bg-neutral-950 text-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6 text-center space-y-8">
          ...
          >
            AI-powered protein structure prediction platform accelerating
      ...
      <section className="bg-white text-neutral-900 py-28">

        <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16">

          <div className="space-y-6">
            <h2 className="text-4xl font-bold leading-tight">
              From the Lab<br />to the Clone.
            </h2>

            <p className="text-lg text-neutral-600">
              Foldexa democratizes protein engineering by combining
              diffusion models with AlphaFold pipelines into a seamless
              AI workflow.
            </p>
          </div>

          <div className="bg-neutral-50 rounded-2xl p-8 border border-neutral-200 space-y-4">
      ...
      <section className="bg-neutral-100 py-28 text-neutral-900">
        ...
        <div className="max-w-5xl mx-auto px-6 space-y-10">
          ...
          {[
            ...
            <div
              key={step}
              className="flex items-center gap-6 p-6 bg-white rounded-xl border"
            >
      ...
      <section className="bg-neutral-950 py-28 text-center">
        ...
        <div className="max-w-3xl mx-auto px-6 space-y-6">
          ...
          <p className="text-lg text-neutral-300">
            Making protein engineering accessible to every researcher
            through intelligent AI tools.
          </p>
      ...
      <section className="bg-white py-28 text-center text-neutral-900">
        ...
        <div className="max-w-3xl mx-auto px-6 space-y-8">
          ...
          <div className="flex justify-center gap-6">
            ...
            <a
              href="mailto:contact@foldexa.com"
              className="px-8 py-4 bg-neutral-900 text-white rounded-xl"
            >
              Email Us
            </a>
