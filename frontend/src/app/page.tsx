        ...
        <section className="sticky top-0 h-screen w-full overflow-hidden flex flex-col items-center justify-center relative bg-black">
          ...
          <div className="relative z-10 w-full max-w-5xl mx-auto px-6 flex flex-col items-center text-center space-y-8">
            ...
            <motion.h1
              ...
              className="text-6xl md:text-8xl lg:text-9xl font-semibold tracking-tight leading-[1.05] text-white/90 drop-shadow-2xl"
            >
              Engineering <br />
            ...
            >
              <Link href="/app/new">
                <Button variant="primary" size="lg" className="min-w-[240px] shadow-[0_0_40px_rgba(0,255,148,0.3)] hover:shadow-[0_0_60px_rgba(0,255,148,0.5)] transition-shadow duration-500 h-16 px-10 text-xl">
                  Start Folding <ArrowRight className="ml-2 w-6 h-6" />
                </Button>
              </Link>
              <Button variant="glass" size="lg" className="min-w-[240px] h-16 px-10 text-xl bg-black/40 hover:bg-black/60 border-white/20">
                <Play className="mr-2 w-6 h-6 fill-current" /> Watch Demo
              </Button>
            </motion.div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-20 mb-20">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  { name: "DiffAb", desc: "Antibody CDR Design", color: "bg-blue-500" },
                  { name: "RFdiffusion", desc: "Scaffold Generation", color: "bg-purple-500" },
                  { name: "AlphaFold2", desc: "Structure Validation", color: "bg-orange-500" },
                ].map((model, idx) => (
                  <motion.div
                    key={model.name}
